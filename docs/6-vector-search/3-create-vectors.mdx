...
<Screenshot src="img/screenshots/6-vector-search/3-create-vectors/1-signup.png" url="https://openai.com/" alt="The OpenAI signup page" />
...
<Screenshot src="img/screenshots/6-vector-search/3-create-vectors/2-create-key.png" url="https://platform.openai.com/account/api-keys" alt="The OpenAI API keys page" />
...
<Screenshot src="img/screenshots/6-vector-search/3-create-vectors/3-api-key.png" url="https://platform.openai.com/account/api-keys" alt="The OpenAI API key" />
...
You can find the 1586 dimensions vector in `vectorizedPlot` field of the books.
...
If you don't have an OpenAI API key, you can use the `serverlessEndpoint` value. This will tell the application to use a serverless function we created for you.
