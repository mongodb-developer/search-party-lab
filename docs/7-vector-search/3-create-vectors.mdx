...
<Screenshot src="img/screenshots/7-vector-search/3-create-vectors/1-signup.png" url="https://openai.com/" alt="The OpenAI signup page" />
...
<Screenshot src="img/screenshots/7-vector-search/3-create-vectors/2-create-key.png" url="https://platform.openai.com/account/api-keys" alt="The OpenAI API keys page" />
...
<Screenshot src="img/screenshots/7-vector-search/3-create-vectors/3-api-key.png" url="https://platform.openai.com/account/api-keys" alt="The OpenAI API key" />
