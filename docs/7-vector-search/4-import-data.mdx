...
| -------- | ----- | ------------- |
| Google Vertex | multimodalembedding@001 | [Docs](https://cloud.google.com/vertex-ai/docs/generative-ai/embeddings/get-multimodal-embeddings) |
| OpenAI | text-embedding-ada-002 | [Docs](https://platform.openai.com/docs/guides/embeddings) |
| SageMaker | jumpstart-dft-hf-textembedding-all-minilm-l6-v2 | [Docs](https://docs.aws.amazon.com/sagemaker/latest/dg/object2vec-encoder-embeddings.html) |
