...
:::tip
The Atlas UI can start feeling a bit cramp at this point. You can also use the aggregation pipeline builder in <Link href="https://www.mongodb.com/products/tools/compass">Compass</Link> for a better experience.
:::
