...
:::info
When your search index reaches status **Active**, you'll be able to see more information about the index — for example, the number of indexed documents, the field mappings, and the index size. Notice also that you're using one out of the three free search indexes that come with your free M0 database.
:::
